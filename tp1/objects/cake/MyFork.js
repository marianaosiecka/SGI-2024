...
class MyFork extends THREE.Object3D {
    ...
    /**
       ...
       @param {number} height The height of the fork
       @param {number} width The width of the fork
       @param {number} depth The depth of the fork
       @param {String} color The color of the fork material
    */
