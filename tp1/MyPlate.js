...
class MyPlate extends THREE.Object3D  {
    ...
    */ 
    constructor(app, radius, height, radialSegments, xPos, yPos, zPos, colorTop, colorBase) {
        super();
        this.app = app;
        this.type = 'Group';
        ...
        this.baseMesh.position.x = xPos;
        this.baseMesh.position.y = yPos - height - 0.03;
        this.baseMesh.position.z = zPos;
