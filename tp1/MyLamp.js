...
class MyLamp extends THREE.Object3D  {
    ...
    */ 
    constructor(app, radiusCable, radiusTop, radiusLight, height, radialSegments, xPos, yPos, zPos, colorCable, colorTop, colorLight, spotLight) {
        super();
        this.app = app;
        this.type = 'Group';

        this.cable = new THREE.CylinderGeometry(radiusCable, radiusCable, height, radialSegments);         
        this.cableMaterial = new THREE.MeshBasicMaterial({ color: colorCable });
        ...
        this.lightMesh.position.y = yPos - height/2 - radiusTop/2 - radiusLight/3;
