...
class MyChoosePlayerVehicleMenu extends THREE.Object3D {
     ...
     * @param num - 1 for right button, -1 for left button
     */
    updateChoosePlayerVehicleMenu(num) {
        ...
        // if the index is out of bounds, set it to the other end of the array
        if (newCameraIndex < 0) {
     ...
     * @returns {THREE.Object3D} - the button
     */
    addArrowButton(name) {
        // circle
    ...
    /**
     * handles the hover of the button
